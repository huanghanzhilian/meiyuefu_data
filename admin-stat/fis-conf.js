...
var staticsPath = '/static-stat';
var pagePrePath = '/static-stat';

var isPublish = ['sandbox','publish'].indexOf(process.title.split(/\s/)[3]) != -1;
if (isPublish) {
    staticsPath = '/_released/resources/static-stat';
    pagePrePath = '/_released/views/static-stat';
}
...
fis.config.merge({
    ...
    roadmap: {
        ...
        path: [
            ...
            {
                reg: /^\/shouzu\/(.*)/i,
                release: isPublish?false:'/shouzu/$1'
            },
            {
