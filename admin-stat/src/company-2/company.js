...
'directive/jrPlaceholder'
    ...
    app.registerController('CtrlCompany-2', ['$scope','$rootScope', '$http', '$modal', '$state', '$stateParams', '$filter','FileUploader',
    function ($scope,$rootScope, $http, $modal, $state, $stateParams, $filter,FileUploader) {
        ...
        function getData(params) {
            $http.get('/shouzu/stat/company/json/get/getCompanyPage', {
        ...
        $scope.addCompany = function(event) {
            window.open("#/index/systemTow/company/add")
        };
