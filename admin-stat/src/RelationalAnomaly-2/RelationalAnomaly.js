...
define([
    ...
    app.registerController('RelationalAnomaly-2', ['$scope', '$http', '$modal', '$state', '$stateParams', '$filter','FileUploader',
...
//                            curveness: 0.2
            ...
            function getCityData(params,callback) {
                $http.get('/shouzu/manage/highRisk-order/json/get/warnRelationGraph', {
