...
define([
    ...
    app.registerController('CtrlCompanyDetail-2', ['$scope', '$http', '$state', '$stateParams', '$modal',
        function($scope, $http, $state, $stateParams, $modal) {
            ...
            //如果公司为空$scope.queryParams.type="add";
             ...
             * bankName
             * isPublic  是否对公
             * canYuefu   清退公寓是否返回服务费
             * companyProvinceCode  获得省份全部
             * companyCityCode  获得给定省份的城市
             * provinceCode  获得省份全部
             * cityCode   获得给定省份的城市
             */
            $scope.queryOptions = {
            ...
            function getData(params) {
                $scope.loading=false
                $http.get('/shouzu/stat/company/json/get/getCompanyInfo', {
            ...
            $scope.changeself=function(e){
                ...
                $http.get('/shouzu/stat/company/json/get/getBankName', {
                    params: {
                        keyword: newValue
                    }
                }).success(function(data, status, headers, config) {
            ...
            $scope.save=function($event){
                ...
                $http.post('/shouzu/stat/company/json/operate/saveAgentCompany', $.param(params)).success(function(data, status, headers, config) {
