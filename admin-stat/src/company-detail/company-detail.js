    ...
    app.registerController('CtrlCompanyDetail', ['$scope', '$http', '$state', '$stateParams', '$modal',
        function($scope, $http, $state, $stateParams, $modal) {
            ...
            $scope.queryOptions = {
                ...
                serviceRate:[{
                    value: '1,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7',
                    name: '1,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7'
                }],
            ...
            $scope.orders = {
                    ...
                    companyMore: {
                        ...
                        city: "北京市",
                        freeDay:"0", //免罚息天数，默认值为0
                        overdueRate:"0.3"   //逾期罚息%，默认值为0.3
                    },
                    companyRelation: {
                        maxMonthRent: "3000",
